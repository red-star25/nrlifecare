...
export const metadata: Metadata = {
  ...
  description: `Contact N R Life Care in Ahmedabad for pricing on APIs, excipients, intermediates and specialty chemicals. Call ${company.phonePrimary} or email ${company.email}. Open ${company.hours}.`,
    ...
    <>
      ...
      <section className="shell py-14 md:py-20">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-14">
          {/* Form */}
          <Reveal>
            <div className="rounded-4xl border border-sand-200 bg-white p-6 md:p-9">
          ...
          <div className="space-y-4">
            <Reveal delay={0.06}>
              <div className="relative overflow-hidden rounded-4xl bg-ink-950 p-7 md:p-8">
                <div className="grid-lines pointer-events-none absolute inset-0 opacity-50" />
                <div
                  className="glow pointer-events-none absolute -top-16 -right-12 h-56 w-56 opacity-25"
                  aria-hidden="true"
                />
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span>
                          ...
                          <span className="mt-1 block text-[17px] font-bold text-white transition-colors group-hover:text-brand-300">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span className="min-w-0">
                          ...
                          <span className="mt-1 block truncate text-[16px] font-semibold text-white transition-colors group-hover:text-brand-300">
                            {company.email}
                          </span>
                        </span>
                      </a>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span>
                          ...
                          <span className="mt-1 block text-[16px] font-semibold text-white transition-colors group-hover:text-brand-300">
                            Message us directly
                          </span>
                        </span>
                      </a>
